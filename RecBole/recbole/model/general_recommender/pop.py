...
class Pop(GeneralRecommender):
    ...
    def calculate_loss(self, interaction):
        ...
        #fix Pop to return actual count, instead of binary indicator of existence
        unique_item, count = torch.unique(item, return_counts=True)
        self.item_cnt[unique_item, :]  = self.item_cnt[unique_item, :] + count.reshape(-1,1)
